...
class RAM1:
  ...
  def __init__(self, bit_depth, positions):
...
class WISARD1:
  ...
  def __init__(self, discriminants, bits, signature_size, bit_depth):
    self.discriminants = []
    
    for i in xrange(0,discriminants):
      self.discriminants.append(DISCRIMINANT1(bits, signature_size, bit_depth))
